    ...
    return (
      ...
      <body>
       ...
       <Card class="card-a">
          ...
          <h1 class="ctext">Give some thinks for poor students in Mannar.</h1>
			...
			<Card class="card1-a">
				...
				<CardContent>
					<Typography class="typo">
          <h1 class="ctext">Give some thinks for poor students in Hatton.</h1>
      ...
      <Card class="card2-a">
				...
				<CardContent>
					<Typography class="typo">
          <h1 class="ctext">Give some thinks and money for poor students in Mullaitheevu.</h1>
