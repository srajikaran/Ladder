  ...
  <a href="/donation/donation">
     <h class="page">Donation </h>
                        ...
                        <div className="form-group-S">
                            ...
                            <input type="string" className="form-control" placeholder="Enter your amount" />


                            <div>
                                <button type="submit" className="btn"> <a href="./payment">payment </a></button>
                            </div>
                        </div>
